                            ...
                            <div class="card-body">
                                <form action="process_add_employee.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter employee's full name" required />
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="department" name="department" required>
                                            ...
                                            <option value="Metro Chief Executive's Office">Metro Chief Executive's Office</option>
                                            <option value="Metro Coordinating Director">Metro Coordinating Director</option>
                                    ...
                                    <button type="submit" class="btn btn-add-employee" style="background-color: #6861CE; border-color: #6861CE; color: #fff;">
                                        Add Employee
                                    </button>
                                </form>
                            </div>
